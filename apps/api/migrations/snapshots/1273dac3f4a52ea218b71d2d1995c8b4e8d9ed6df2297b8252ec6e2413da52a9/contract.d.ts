...
export type StorageHash =
  StorageHashBase<'1273dac3f4a52ea218b71d2d1995c8b4e8d9ed6df2297b8252ec6e2413da52a9'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly PhotoContestSubmission: {
      readonly id: CodecTypes['pg/text@1']['output'];
      readonly contestId: CodecTypes['pg/text@1']['output'];
      readonly userId: CodecTypes['pg/text@1']['output'];
      readonly tripId: CodecTypes['pg/text@1']['output'];
      readonly coverStoragePath: CodecTypes['pg/text@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    readonly PhotoContestVote: {
      readonly id: CodecTypes['pg/text@1']['output'];
      readonly contestId: CodecTypes['pg/text@1']['output'];
      readonly userId: CodecTypes['pg/text@1']['output'];
    ...
    readonly User: {
      ...
      readonly residenceCountryId: CodecTypes['pg/text@1']['output'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
  };
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly PhotoContestSubmission: {
      readonly id: CodecTypes['pg/text@1']['input'];
      readonly contestId: CodecTypes['pg/text@1']['input'];
      readonly userId: CodecTypes['pg/text@1']['input'];
      readonly tripId: CodecTypes['pg/text@1']['input'];
      readonly coverStoragePath: CodecTypes['pg/text@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly PhotoContestVote: {
      readonly id: CodecTypes['pg/text@1']['input'];
    ...
    readonly User: {
      ...
      readonly residenceCountryId: CodecTypes['pg/text@1']['input'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
  };
        ...
        readonly entries: {
          readonly table: {
              ...
              indexes: readonly [
                {
                  ...
                  readonly prefix: 'photoContest_countryId_endsAt_id_idx';
                  readonly columns: readonly ['countryId', 'endsAt', 'id'];
                  readonly unique: false;
                },
                {
                  readonly name: 'photoContest_startsAt_id_idx_8f6c6775';
                  readonly prefix: 'photoContest_startsAt_id_idx';
                  readonly columns: readonly ['startsAt', 'id'];
                  readonly unique: false;
                },
                {
                  readonly name: 'photoContest_countryId_idx_27b43b27';
                  readonly prefix: 'photoContest_countryId_idx';
                  readonly columns: readonly ['countryId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'photoContest_winnerSubmissionId_idx_27cae014';
                  readonly prefix: 'photoContest_winnerSubmissionId_idx';
                  readonly columns: readonly ['winnerSubmissionId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'photoContest';
                    readonly columns: readonly ['countryId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
                ...
                },
                {
                  ...
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'photoContestSubmission';
                    readonly columns: readonly ['id'];
                  };
                },
              ];
            ...
            readonly photoContestSubmission: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [
                { readonly columns: readonly ['contestId', 'userId'] },
                { readonly columns: readonly ['contestId', 'id'] },
              ];
              indexes: readonly [
                {
                  readonly name: 'photoContestSubmission_tripId_coverStoragePath_idx_3c56c9ff';
                  readonly prefix: 'photoContestSubmission_tripId_coverStoragePath_idx';
                  readonly columns: readonly ['tripId', 'coverStoragePath'];
                  readonly unique: false;
                },
                {
                  readonly name: 'photoContestSubmission_contestId_idx_8a30d986';
                  readonly prefix: 'photoContestSubmission_contestId_idx';
                  readonly columns: readonly ['contestId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'photoContestSubmission_userId_idx_a489d58a';
                  readonly prefix: 'photoContestSubmission_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'photoContestSubmission_tripId_idx_75da6d97';
                  readonly prefix: 'photoContestSubmission_tripId_idx';
            ...
            readonly photoContestVote: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['contestId', 'userId'] }];
              indexes: readonly [
                {
                  readonly name: 'photoContestVote_submissionId_idx_89cd3f4e';
                  readonly prefix: 'photoContestVote_submissionId_idx';
                  readonly columns: readonly ['submissionId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'photoContestVote_contestId_idx_8a30d986';
                  readonly prefix: 'photoContestVote_contestId_idx';
                  readonly columns: readonly ['contestId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'photoContestVote_userId_idx_a489d58a';
                  readonly prefix: 'photoContestVote_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'photoContestVote_contestId_submissionId_idx_3198671f';
                  readonly prefix: 'photoContestVote_contestId_submissionId_idx';
                  readonly columns: readonly ['contestId', 'submissionId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'photoContestVote';
                    readonly columns: readonly ['contestId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly tripCountry: {
              ...
              uniques: readonly [{ readonly columns: readonly ['tripId', 'position'] }];
              indexes: readonly [
                {
            ...
            readonly user: {
              ...
              indexes: readonly [
                {
                  readonly name: 'user_residenceCountryId_idx_410126ba';
                  readonly prefix: 'user_residenceCountryId_idx';
                  readonly columns: readonly ['residenceCountryId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
          ...
          readonly valueSet: {
            readonly photo_contest_status: {
              readonly kind: 'valueSet';
              readonly values: readonly ['OPEN', 'CLOSED'];
            };
            readonly trip_visibility: {
              readonly kind: 'valueSet';
...
> & {
  ...
  readonly roots: {
    ...
    readonly photoContest: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'PhotoContest';
    };
    readonly photoContestSubmission: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'PhotoContestSubmission';
    };
    readonly photoContestVote: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'PhotoContestVote';
    };
  };
  readonly domain: {
    readonly namespaces: {
          ...
          readonly PhotoContest: {
            ...
            readonly relations: {
              ...
              readonly winner: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['winnerSubmissionId'];
                  readonly targetFields: readonly ['id'];
                };
              };
            };
            readonly storage: {
              readonly table: 'photoContest';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                ...
                readonly winnerSubmissionId: { readonly column: 'winnerSubmissionId' };
                readonly createdAt: { readonly column: 'createdAt' };
              };
            };
          };
          readonly PhotoContestSubmission: {
            ...
            readonly relations: {
              readonly contest: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['contestId'];
                  readonly targetFields: readonly ['id'];
                };
              };
              readonly trip: {
            ...
            readonly storage: {
              readonly table: 'photoContestSubmission';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly contestId: { readonly column: 'contestId' };
          ...
          readonly PhotoContestVote: {
            ...
            readonly relations: {
              ...
              readonly submission: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['contestId', 'submissionId'];
                  readonly targetFields: readonly ['contestId', 'id'];
                };
              };
              readonly user: {
                readonly to: { readonly namespace: 'public' & NamespaceId; readonly model: 'User' };
            ...
            readonly storage: {
              readonly table: 'photoContestVote';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly contestId: { readonly column: 'contestId' };
          ...
          readonly User: {
            ...
            readonly relations: {
              readonly residenceCountry: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['residenceCountryId'];
                  readonly targetFields: readonly ['id'];
                };
              };
              readonly trips: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly residenceCountryId: { readonly column: 'residenceCountryId' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };

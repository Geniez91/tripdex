...
const countries = [
  { id: 'fr', iso2: 'FR', iso3: 'FRA', name: 'France', slug: 'france', continentCode: 'EU' },
  { id: 'jp', iso2: 'JP', iso3: 'JPN', name: 'Japan', slug: 'japan', continentCode: 'AS' },
];

function snapshot(rows: ProgressionSnapshot['tripCountries']): ProgressionSnapshot {
  return { countries, tripCountries: rows };
}

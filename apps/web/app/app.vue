...
<template>
  <div class="site-shell">
    ...
    <header class="site-header">
      <a href="/" class="wordmark" aria-label="TripDex, accueil"
        ><span class="brand-icon" aria-hidden="true">↗</span>Trip<span>Dex</span
        ><span class="brand-dot">.</span></a
      >
      <span class="header-note">VOTRE CARNET DE VOYAGE</span>
    </header>
    <main>
          ...
          <div class="map-footer">
            <template v-if="visitedStatus === 'success' && !visited.length"
              ...
              <div>
                ...
                <p>
                  Loggez votre premier voyage : ses pays prendront couleur sur
                  la carte.
                </p>
              </div></template
            >
